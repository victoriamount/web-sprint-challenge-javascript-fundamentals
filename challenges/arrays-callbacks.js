...
console.log("A-C Request 1: (complete) ");
...
*/
console.log("A-C Request 2: (complete)");

// let lowCaseAnimalNames = [];
// function makeLowCaseNames(data){
//   lowCaseAnimalNames = data.map(function(item){
...
*/
console.log("A-C Request 3: (complete)");
...
console.log("A-C Request 4: (complete)");
...
console.log("A-C Step 3: (complete)")
